...
public class TagRepository implements ITagRepository {
    ...
    public CrowdTagsJobEntity queryCrowdTagsJobEntity(String tagId, String batchId) {
        ...
        return CrowdTagsJobEntity.builder().tagType(crowdTagsJobRes.getTagType()).tagRule(crowdTagsJobRes.getTagRule()).statStartTime(crowdTagsJobRes.getStatStartTime()).statEndTime(crowdTagsJobRes.getStatEndTime()).build();
    }
